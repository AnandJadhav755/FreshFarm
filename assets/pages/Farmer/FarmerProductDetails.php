          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
               ...
               <div class="list-group moblists">
                    ...
                    if (isset($_SESSION['Auth'])) {
                         ...
                         echo "<a href='?transactions' class='list-group-item list-group-item-action' style='background-color:#292b2c;text-align:center;color:goldenrod'>Orders</a>";
                         ...
                         echo "<a href='?login'> <div class='text-success  logins '>Login</div></a>";
                    }
                    ?>
...
if (isset($_GET['id'])) {
    $prod_id = $_GET['id'];
    $product = checkStokes($prod_id);

    if ($product) {
     
        $product_title = $product['name'];
        $product_image = $product['photo_url'];
        ...
        $str = ($product_stock == 0) ? "Not In Stock" : "In Stock";

        echo "<div class='container'>
                <div class='row'>
                    <div class='col-md-6' style='padding:7px; margin-top:15px;'>
                        <img src='assets/images/$product_image' class='rounded mx-auto d-block bord' height='250px' width='300px'>      
                        <br>
                    ...
                    <div class='col-md-6 blackgoldie'>
                        ...
                        <h3 style='color:white;padding:7px;'>Product Stock: $product_stock Kgs</h3>
                      

                        <div class='row' style='padding:7px; margin-bottom:15px;' >
                            <div class='col-6'> <a href='?EditProduct&id=$prod_id' class='btn btn-warning border-secondary' style='color:black'><b>Edit Product</b></a></div>
                            <div class='col-6'> <a href='?transactions' class='btn btn-warning border-secondary' style='color:black'><b>My Transaction</b></a></div>
                        </div>
                    </div>         
                </div>
                <div class='container'>
        ...
        echo "<h1 align='center'>Product Not Found!</h1>";
    }
} else {
    echo "<h1 align='center'>Invalid Product ID!</h1>";
}
?>
